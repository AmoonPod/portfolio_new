...
export const sitiWebDataset: LocalPageData[] = [
  ...
  },
  {
    ...
    "offers": [
      {
        "id": "landing-montagna-sprint",
        "title": "Landing Montagna Sprint",
        "description": "In 7 giorni hai una pagina pensata per farti contattare: chiamate, WhatsApp e richieste, con una resa perfetta da smartphone.",
        "price": "599",
        "badge": "Promo Montagna",
        "active": true,
        "type": "landing",
      ...
      },
      {
        "id": "sito-completo-montagna",
        "title": "Sito Completo",
        "description": "Un sito professionale, veloce e ben strutturato: ti aiuta a posizionarti e a farti scegliere da nuovi clienti.",
        "price": "899",
        "badge": "Promo Montagna",
        "active": true,
        "type": "website",
    ...
    "seo": {
      ...
      "description": "Creo siti web a Casina per attività locali: veloci anche con connessione instabile, ottimizzati per Google e perfetti da smartphone.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Il passaparola resta importante, ma oggi la prima “stretta di mano” spesso è una ricerca su Google. Un sito fatto bene ti porta credibilità, richieste e clienti anche mentre sei impegnato.",
      "cards": [
        {
          "icon": "star",
          "title": "Prima impressione che convince",
          "description": "In pochi secondi una persona decide se fidarsi o passare oltre.",
          "description2": "Un sito moderno e ordinato racconta cura, serietà e qualità del tuo lavoro.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          "title": "La tua presenza online, davvero tua",
          "description": "I social cambiano regole e visibilità: oggi ci sei, domani non si sa.",
          "description2": "Il sito è il tuo spazio: stabile, controllabile e costruito per durare.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Meno perditempo, più contatti utili",
          "description": "Un sito fatto bene risponde alle domande principali e guida l’utente.",
          "description2": "Arrivano richieste più chiare, da persone già interessate a ciò che offri.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "offers": [
      {
        "id": "landing-montagna-sprint",
        "title": "Landing Montagna Sprint",
        "description": "In 7 giorni metti online una pagina che spinge all’azione: contatti rapidi, WhatsApp, chiamate e richieste, perfetta da mobile.",
        "price": "599",
        "badge": "Promo Montagna",
        "active": true,
        "type": "landing",
      ...
      },
      {
        "id": "sito-completo-montagna",
        "title": "Sito Completo",
        "description": "Un sito completo e professionale: struttura SEO, velocità e contenuti per superare la concorrenza nelle ricerche locali.",
        "price": "899",
        "badge": "Promo Montagna",
        "active": true,
        "type": "website",
    ...
    "seo": {
      ...
      "description": "Realizzazione siti web a Carpineti: veloci, ottimizzati SEO e pensati per portarti clienti da Google. Perfetti da smartphone.",
    ...
    "diagnostica": {
      "badge": "Diagnostica Attuale",
      "title": "Se ti cercano su Google, cosa trovano? E cosa trovano i tuoi competitor?",
      "problems": [
    ...
    "goodInvestment": {
      ...
      "subtitle": "Un sito ben fatto non è “una cosa in più”. È lo strumento che trasforma le ricerche in contatti, e i contatti in clienti. Con me hai un sito web di qualità, con dati e risultati misurabili.",
      "cards": [
        {
          "icon": "star",
          "title": "Credibilità immediata",
          "description": "Oggi un’attività senza sito sembra meno affidabile, anche se lavora benissimo.",
          "description2": "Un sito curato mette ordine, autorevolezza e fa percepire valore.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          "title": "Solido e sicuro",
          "description": "Tecnologia pulita, privacy rispettata e niente fronzoli che rallentano.",
          "description2": "L’obiettivo è avere un sito stabile, veloce e che non ti crei problemi.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Un alleato che filtra e vende",
          "description": "Non devi ripetere sempre le stesse cose a ogni nuovo contatto.",
          "description2": "Il sito spiega, rassicura e porta richieste più qualificate.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "offers": [
      {
        "id": "onepage-pro",
        "title": "One Page Pro",
        "description": "Una pagina fatta bene per farti contattare: messaggio chiaro, mobile perfetto e pulsanti di contatto subito visibili.",
        "price": "890",
        "badge": "Pro",
        "active": true,
        "type": "landing",
      ...
      },
      {
        ...
        "description": "Un sito snello e professionale: chiaro, veloce e pensato per farti trovare e ricevere richieste senza complicazioni.",
        "price": "1490",
        "badge": "Essenziale",
        "active": true,
        "type": "website",
    ...
    "seo": {
      ...
      "description": "Sviluppo siti web a Vignola: veloci, ottimizzati per Google e perfetti da smartphone. Un sito fatto bene che converte i visitatori in clienti paganti.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Un sito fatto bene non serve semplicemente a “esserci” online. Serve a generare fiducia, richieste e clienti, con risultati che puoi vedere e misurare: risultati che aumentano il tuo fatturato. ",
      "cards": [
        {
          "icon": "star",
          "title": "Impatto immediato",
          "description": "In pochi secondi una persona decide se contattarti o cercare altrove.",
          "description2": "Un design pulito, testi chiari e informazioni in ordine fanno percepire qualità, e il cliente si accorgerà che se il tuo sito è di qualità, anche la tua azienda/attività lo sono.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          "title": "Una base stabile, non più in affitto",
          "description": "I social sono utili, ma non li controlli: regole, algoritmo e visibilità cambiano di continuo.",
          "description2": "Il sito è la tua casa digitale: resta, si posiziona e accumula valore nel tempo.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Più richieste, meno fatica",
          "description": "Non devi ripetere sempre le stesse cose a ogni cliente.",
          "description2": "Il sito spiega, rassicura e porta contatti più pronti a sceglierti",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "offers": [
      {
        "id": "onepage-pro",
        "title": "One Page Pro",
        "description": "Una pagina fatta bene per richieste e preventivi: chiara, veloce e perfetta su mobile, con contatti subito a portata di mano.",
        "price": "890",
        "badge": "Pro",
        "active": true,
        "type": "landing",
      ...
      },
      {
        "id": "sito-essenziale-5p",
        "title": "Sito Essenziale (fino a 5 pagine)",
        "description": "Un sito snello e professionale: autorevole, chiaro e veloce. Ti aiuta a presentarti bene e a ricevere richieste senza fronzoli.",
        "price": "1490",
        "badge": "Essenziale",
        "active": true,
        "type": "website",
    ...
    "seo": {
      ...
      "description": "Realizzazione siti web a Fiorano Modenese: veloci, ottimizzati SEO e pensati per generare contatti (preventivi, chiamate e WhatsApp).",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Non è “una spesa”. È uno strumento che DEVE portare richieste, aiutarti a vendere meglio e a distinguerti in un mercato competitivo facendo capire perchè devono scegliere te, in un mare di opportunità.",
      "cards": [
        {
          "icon": "star",
          "title": "Autorevolezza e fiducia",
          "description": "Quando il sito è ordinato e chiaro, la percezione del cliente in merito alla tua azienda cambia subito.",
          "description2": "I clienti capiscono che sei ben organizzato e che possono affidarsi a te.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          "title": "Controllo totale",
          "description": "Sui social dipendi da continui cambi di algoritmi e limiti della piattaforma. ",
          "description2": "Sul sito decidi tu i contenuti, decidi tu come farti contattare e decidi tu il percorso da far seguire al tuo potenziale cliente per convertirlo da visitatore a cliente.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Un agente di vendita sempre attivo",
          "description": "Il sito risponde alle domande più comuni e guida gli utenti a contattarti.",
          "description2": "Tu ricevi richieste più chiare e perdi meno tempo con persone che ti fanno sempre le stesse domande.",
          "footerType": "roi"
        }
      ]
    },
