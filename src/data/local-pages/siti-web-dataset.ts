...
export const sitiWebDataset: LocalPageData[] = [
...

  {
    ...
    region: 'Emilia-Romagna',
    geo: {
      lat: 44.3, // opzionale: puoi sostituire con coordinate precise
      lng: 10.3, // opzionale: puoi sostituire con coordinate precise
    },
    population: 4500,
    active: true,
    serviceSlug: 'siti-web',
    ...
    hero: {
      h1: 'A Casina il sito deve essere leggero, veloce e chiaro.',
      sub: 'Qui molte ricerche si fanno al volo dal telefono, magari con poco segnale. Ti realizzo un sito che si apre subito, dice chi sei in pochi secondi e porta contatti: chiamate, WhatsApp e richieste.',
      ctaText: 'Parliamo del tuo sito',
      ctaHref: '#contatti',
    ...
    diagnostica: {
      ...
      problems: [
        'Il sito (se c’è) è pesante e si carica lentamente con rete mobile',
        'Non compari su Google per ricerche tipo “agriturismo Casina” o “(servizio) Casina”',
        'Da smartphone è scomodo: testi piccoli, pulsanti invisibili, info confuse',
        'Hai solo i social: utili, ma non bastano per chi cerca su Google',
        'Foto lente da caricare: l’utente chiude e passa oltre',
        'Numero e contatti non sono immediati (e perdi chiamate)',
      ],
      solutions: [
        'Sito super rapido: ottimizzato per caricamenti immediati anche con poco campo',
        'SEO locale pensata per intercettare chi cerca servizi a Casina e dintorni',
        'Esperienza mobile pulita: chi arriva capisce subito e ti contatta',
        'Contatti in primo piano: click-to-call, WhatsApp, form anti-spam',
        'Immagini leggere ma belle: qualità alta, zero attese',
...

  {
    ...
    region: 'Emilia-Romagna',
    geo: {
      lat: 44.272, // opzionale
      lng: 10.311, // opzionale
    },
    population: 4000,
    active: true,
    serviceSlug: 'siti-web',
    ...
    hero: {
      h1: 'Non lasciare i clienti al concorrente: fatti trovare prima tu.',
      sub: 'A Carpineti il passaparola aiuta, ma oggi chi non ti conosce digita su Google e decide in pochi secondi. Ti creo un sito veloce e convincente, pensato per portare chiamate e richieste reali.',
    ...
    diagnostica: {
      badge: 'Diagnostica Attuale',
      title:
        'Se ti cercano su Google, cosa trovano? E cosa trovano i tuoi rivali?',
      problems: [
        'Sito datato o assente: da mobile si legge male e non invoglia',
        'Non esci nelle ricerche locali per servizi e attività a Carpineti',
        'Informazioni sparse o vecchie: orari, contatti, posizione non chiari',
        'Caricamento lento: l’utente non aspetta e chiude',
      ...
      solutions: [
        ...
        'SEO locale per posizionarti su ricerche legate a Carpineti e dintorni',
    ...
    goodInvestment: {
      ...
      subtitle:
        'Un sito ben fatto non è “una cosa in più”. È lo strumento che trasforma le ricerche in contatti, e i contatti in clienti. Con dati e risultati misurabili.',
      cards: [
        {
          icon: 'star',
...

  {
    ...
    seo: {
      ...
      description:
        'Sviluppo siti web a Vignola: veloci, ottimizzati per Google e perfetti da smartphone. Un sito che non “sta online”, ma porta clienti.',
    ...
    hero: {
      h1: 'A Vignola la concorrenza è forte: il sito deve farti scegliere.',
      sub: 'Che tu sia un ristorante, un professionista o un’attività locale, oggi il primo confronto avviene su Google. Ti realizzo un sito veloce, chiaro e convincente: così chi cerca ti trova, capisce subito il valore e ti contatta.',
      ctaText: 'Parliamo del tuo sito',
      ctaHref: '#contatti',
    ...
    diagnostica: {
      ...
      problems: [
        'Il sito è lento: su mobile le persone abbandonano in pochi secondi',
        'Non compari quando cercano “(servizio) Vignola” o “(attività) Vignola”',
        'Da smartphone è scomodo: contatti nascosti, testi piccoli, info confuse',
        'Hai speso soldi in passato ma senza risultati misurabili',
        'Le richieste che arrivano sono poche o poco qualificate',
        'La presentazione online non valorizza davvero ciò che fai',
      ],
      solutions: [
        'Prestazioni vere: caricamento rapido e navigazione pulita',
        'SEO locale pensata per intercettare ricerche a Vignola e dintorni',
    ...
    goodInvestment: {
      ...
      subtitle:
        'Un sito fatto bene non serve a “esserci”. Serve a generare fiducia, richieste e clienti, con risultati che puoi vedere e misurare.',
      cards: [
        {
          icon: 'star',
          ...
          description2:
            'Un design pulito, testi chiari e informazioni in ordine fanno percepire qualità.',
          footerType: 'premium',
        },
        {
          icon: 'shield',
          title: 'Una base stabile, non in affitto',
          description:
            'I social sono utili, ma non li controlli: regole e visibilità cambiano di continuo.',
          description2:
        ...
        },
        {
          ...
          description2:
            'Il sito spiega, rassicura e porta contatti più pronti a scegliere.',
          footerType: 'roi',
        },
      ],
    },
...

  {
    ...
    hero: {
      h1: 'A Fiorano chi cerca è pratico: il sito deve portare subito al contatto.',
      sub: 'Tra attività locali e aziende, contano chiarezza e velocità: chi entra deve capire in pochi secondi cosa fai e come chiederti un preventivo. Ti creo un sito snello, professionale e ottimizzato per Google.',
      ctaText: 'Parliamo del progetto',
      ctaHref: '#contatti',
    ...
    diagnostica: {
      badge: 'Diagnostica Attuale',
      title: 'Il tuo sito sta generando opportunità… o solo “presenza”?',
      problems: [
        'Il sito non comunica bene i servizi: chi entra non capisce e se ne va',
        'Non compari su Google per ricerche locali legate ai tuoi servizi',
        'Da mobile è macchinoso: contatti e preventivo non sono immediati',
        'Arrivano poche richieste o richieste troppo vaghe',
        'Sito lento o disordinato: dà una sensazione poco professionale',
        'Le informazioni importanti non sono in evidenza (orari, contatti, dove sei)',
      ],
      solutions: [
        'Messaggio chiaro: cosa fai, per chi, perché scegliere te',
        'SEO locale per intercettare chi cerca a Fiorano e dintorni',
        'Mobile-first con CTA visibili: WhatsApp, chiamata, richiesta preventivo',
        'Form contatti chiaro e guidato, per richieste più utili',
        'Velocità e pulizia visiva per aumentare fiducia',
        'Informazioni essenziali ben in evidenza, senza confusione',
      ],
    },
    goodInvestment: {
      title: 'Un sito ben fatto è un',
      titleHighlight: 'asset che ti fa crescere',
      subtitle:
        'Non è “una spesa” da tenere accesa. È uno strumento che deve portare richieste, aiutarti a vendere meglio e a distinguerti in un mercato competitivo.',
      cards: [
        {
          icon: 'star',
          title: 'Autorevolezza e fiducia',
          description:
            'Quando il sito è ordinato e chiaro, la percezione cambia subito.',
          description2:
            'I clienti capiscono che sei strutturato e che possono affidarsi a te.',
          footerType: 'premium',
        },
        {
          icon: 'shield',
          ...
          description:
            'Sui social dipendi da algoritmi e limiti di piattaforma.',
          description2:
            'Sul sito decidi tu: contenuti, contatti e percorso utente.',
          footerType: 'ownership',
        },
        {
          icon: 'zap',
          title: 'Un commerciale sempre attivo',
          description:
            'Il sito risponde alle domande e guida verso il contatto.',
          description2:
            'Tu ricevi richieste più chiare e perdi meno tempo con contatti “a vuoto”.',
          footerType: 'roi',
        },
      ],
    },
    faq: [
      ...
      },
      {
        ...
        a: 'Il passaparola è oro, ma molte persone controllano online prima di chiamare. Un sito curato trasforma “interessati” in contatti.',
      },
      {
        q: 'Ci sono canoni annuali?',
        a: "Sì: oltre ai canoni della piattaforma di hosting e del dominio, offro ai miei clienti la possibilità di avere un'assistenza configurabile su tre livelli, che ti permette di concentrarti sul tuo lavoro e dormire sonni tranquilli, perché al tuo sito ci penso io.",
