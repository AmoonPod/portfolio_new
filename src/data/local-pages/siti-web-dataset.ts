...
export const sitiWebDataset: LocalPageData[] = [
  {
    ...
    "offers": [
      {
        ...
        "description": "In 7 giorni hai una pagina che porta contatti (telefono/WhatsApp/richieste) e che comunica bene in mobile.",
        "price": "499",
    ...
    "seo": {
      ...
      "description": "Sviluppo siti web per attività a Castelnovo ne' Monti. Siti web veloci, perfetti anche da smartphone e ottimizzati per scalare le classifiche di Google.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Molti vedono il sito web come un costo fisso, come la bolletta della luce. Io lo costruisco come un investimento che deve generare un ritorno misurabile.",
      "cards": [
        {
          "icon": "star",
          "title": "Il tuo biglietto da visita h24",
          "description": "Mentre tu dormi, il sito lavora. Risponde alle domande, mostra i tuoi lavori e convince i clienti.",
          "description2": "Se è trascurato, lento o non si adatta al cellulare, il cliente penserà che anche il tuo lavoro sia scadente.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          "title": "L'unica cosa che possiedi davvero",
          "description": "I social media sono \"in affitto\". Se domani l'algoritmo cambia o ti bloccano il profilo, sparisci nel nulla.",
          "description2": "Un sito web è casa tua. Nessuno può togliertelo. È un asset sicuro che accumula valore storico nel tempo.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Un venditore che non chiede stipendio",
          "description": "Immagina di dover spiegare a ogni singolo cliente chi sei e perché costi quella cifra. Estenuante, vero?",
          "description2": "Un sito ben progettato lo fa al posto tuo. Filtra i perditempo e ti porta solo contatti già convinti.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Realizzazione siti web a Casalgrande. Codice leggero e ottimizzato per aziende e professionisti che vogliono farsi trovare subito.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "I social cambiano le regole ogni giorno. Un sito web veloce e ben fatto è casa tua: nessuno può togliertelo o nascondere i tuoi post.",
      "cards": [
        {
          "icon": "star",
          "title": "Professionalità immediata",
          "description": "Chi cerca online giudica la tua azienda in pochi secondi.",
          "description2": "Un sito veloce e ordinato fa capire subito che lavori bene anche nella realtà.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          "title": "Tutto tuo, per sempre",
          "description": "Non paghi affitti mensili per la piattaforma. Il codice è tuo.",
          "description2": "È un bene aziendale che acquista valore nel tempo e ti rende indipendente.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Assistenza inclusa",
          "description": "Non devi imparare a fare il tecnico. Se c’è un problema, ci sono io.",
          "description2": "Tu pensi a gestire la tua attività, io mi assicuro che il sito rimanga online e veloce.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Realizzazione siti web a Casina. Soluzioni ottimizzate per agriturismi, artigiani e attività dell’Appennino. Veloci anche con connessione lenta.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Soprattutto in montagna, dove il passaparola è forte ma non basta più. Un sito curato ti dà credibilità agli occhi di turisti e nuovi clienti.",
      "cards": [
        {
          "icon": "star",
          "title": "Immagine curata",
          "description": "Presentati al meglio. Un sito disordinato fa pensare a un servizio disordinato.",
        ...
        },
        {
          ...
          "description2": "Il sito resta, è sempre raggiungibile e raccoglie tutte le informazioni importanti in un posto solo.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          ...
          "description2": "Tu mi dici cosa vuoi pubblicare, io lo metto online ottimizzato. Semplice.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Realizzazione siti internet a Carpineti. Aiuto le piccole attività a farsi trovare online con siti veloci e facili da usare.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Un sito web ben fatto lavora per te giorno e notte, rispondendo alle domande dei clienti anche quando sei chiuso o impegnato.",
      "cards": [
        {
          "icon": "star",
          "title": "Credibilità",
          "description": "Oggi, se non hai un sito, la gente si insospettisce.",
          "description2": "Un sito professionale rassicura il cliente che la tua attività è solida e attiva.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
        ...
        },
        {
          ...
          "description2": "Me ne occupo io. Tu non devi preoccuparti di aggiornamenti, backup o problemi tecnici.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Sviluppo siti web a Maranello. Performance eccellenti e design curato per attività che si rivolgono a un pubblico esigente e internazionale.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Non serve spendere cifre folli, serve spendere bene. Un sito ottimizzato ti distingue dalla massa e ti posiziona come un’attività di livello.",
      "cards": [
        {
          "icon": "star",
          "title": "Prima impressione",
          "description": "Hai solo una possibilità per fare una buona prima impressione.",
          "description2": "Un sito veloce e bello dice al cliente: \"Qui si lavora bene\".",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          ...
          "description2": "Il tuo sito sarà solido, protetto e sempre online, senza sorprese.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          ...
          "description2": "Per qualsiasi modifica o aggiornamento, sono a tua disposizione. Tu lavori, io curo il sito.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Siti web a Scandiano per negozi, ristoranti e aziende. Fatti trovare prima dei tuoi concorrenti con un sito veloce e professionale.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Se il tuo sito non funziona bene, il cliente non smette di cercare: va semplicemente da qualcun altro. Riprenditi il tuo spazio.",
      "cards": [
        {
          "icon": "star",
          "title": "Distinguersi",
          "description": "In un mercato affollato, la qualità si nota.",
          "description2": "Un sito curato è segno di un’attività che ci tiene ai dettagli.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          ...
          "description2": "Non ti lego con contratti strani. Sei libero, ma scommetto che resterai per il servizio.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          ...
          "description2": "Un messaggio e risolvo. Avere un tecnico di fiducia fa la differenza.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Sviluppo siti web a Reggio Emilia per aziende e professionisti. Siti veloci, proprietari e ottimizzati per convertire i visitatori in clienti.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Un sito web professionale è l’unico venditore che lavora h24, non chiede ferie e presenta la tua attività esattamente come vuoi tu.",
      "cards": [
        {
          "icon": "star",
          "title": "Reputazione",
          "description": "A Reggio la voce gira, ma oggi la prima verifica si fa online.",
          "description2": "Un sito impeccabile conferma che sei un professionista serio.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          ...
          "description2": "Non costruiamo la tua casa su un terreno in affitto. Sei indipendente e tutelato.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          ...
          "description2": "Tu ti concentri sul tuo lavoro, sapendo che la tua immagine online è in mani sicure.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Sviluppo siti internet a Villa Minozzo. Aiuto ristoranti, alberghi e attività locali a farsi trovare dai turisti e dai residenti con siti belli e veloci.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Mentre tu servi i clienti o gestisci il negozio, il sito risponde alle domande più frequenti: dov’è, cosa si mangia, quanto costa.",
      "cards": [
        {
          "icon": "star",
          "title": "Vetrina H24",
          "description": "Il turista programma la gita la sera prima o la mattina presto.",
          "description2": "Il tuo sito è lì a convincerlo quando tu stai ancora riposando.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          ...
          "description2": "Con un sito tuo, il contatto è diretto. Più margine per te, più rapporto con il cliente.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          ...
          "description2": "Mi mandi la foto del menu nuovo su WhatsApp e io aggiorno il sito. Facile.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Creazione siti web a Sassuolo. Dal piccolo negozio alla PMI, sviluppo siti veloci, sicuri e orientati al business. Preventivo chiaro, zero sorprese.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Nel distretto di Sassuolo la concretezza è tutto. Un sito web di proprietà è un macchinario digitale che produce contatti e visibilità.",
      "cards": [
        {
          "icon": "star",
          "title": "Percezione del valore",
          "description": "Se vendi qualità, devi apparire di qualità.",
          "description2": "Un sito curato giustifica i tuoi prezzi e posiziona il tuo brand in alto.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          ...
          "description2": "Il sito è il tuo quartier generale online, dove decidi tu le regole e i contenuti.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          "title": "Efficienza",
          "description": "Meno telefonate informative, più contatti pronti a comprare.",
          "description2": "Il sito filtra i curiosi e ti porta chi è davvero interessato.",
          "footerType": "roi"
        }
      ]
    },
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Realizzazione siti web a Vignola. Valorizza la tua attività con un sito internet veloce, moderno e capace di attirare clienti che cercano qualità.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Oggi i clienti guardano lo schermo del telefono molto più di quanto guardino le vetrine in strada. Essere lì, e bene, è obbligatorio.",
      "cards": [
        {
          "icon": "star",
          "title": "Eccellenza",
          "description": "Il sito deve essere bello e funzionale quanto il tuo negozio o azienda.",
        ...
        },
        {
          ...
          "description": "Investire sul proprio sito significa investire su se stessi.",
          "description2": "Non sui social network che oggi ci sono e domani chissà.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
  ...
  },
  {
    ...
    "seo": {
      ...
      "description": "Sviluppo siti internet a Viano. Soluzioni web per artigiani e piccole imprese. Siti veloci che portano contatti e lavoro vero.",
    ...
    "goodInvestment": {
      ...
      "subtitle": "Il sito deve ripagarsi portandoti nuovi clienti. Lo costruisco con questo unico obiettivo: generare contatti utili.",
      "cards": [
        {
          "icon": "star",
          "title": "Professionalità",
          "description": "Anche se sei piccolo, presentati come un grande.",
          "description2": "Un sito ordinato dà sicurezza al cliente che deve affidarti un lavoro.",
          "footerType": "premium"
        },
        {
          "icon": "shield",
          ...
          "description2": "Il sito è di tua proprietà. È un investimento che rimane in azienda.",
          "footerType": "ownership"
        },
        {
          "icon": "zap",
          ...
          "description2": "Non ti faccio aspettare settimane. Un messaggio e risolviamo.",
          "footerType": "roi"
        }
      ]
    },
