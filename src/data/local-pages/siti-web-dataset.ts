...
export const sitiWebDataset: LocalPageData[] = [
  {
    ...
    hero: {
      ...
      sub: 'Aiuto agriturismi, artigiani e negozi di Castelnovo a farsi trovare online. Non ti serve un sito complicato, ti serve un sito che porti clienti alla tua attività.',
    ...
    pain: {
      ...
      bullets: [
        ...
        'Hai un sito vecchio che da telefono non funziona (e qui la gente usa solo quello)',
        'Vedi i tuoi clienti rivolgersi alla concorrenza di Reggio o Modena',
        'Ti hanno chiesto cifre assurde per un sito web',
        'La tua scheda su Maps ha foto vecchie e orari sbagliati',
      ],
    },
    solution: {
      title: 'Un sito che lavora per te, mentre sei in laboratorio o in campo',
      highlights: [
        'Veloce davvero, caricamento in meno di 1.5 secondi',
        'Ottimizzato per farti trovare da chi cerca i tuoi servizi in zona',
        'Ricevi ordini o prenotazioni direttamente dal sito',
        'Reattivo e responsive per tutti i dispositivi',
    ...
    uniqueBlocks: [
      {
        kind: 'comparison',
        title: "Un sito 'fatto bene' vince su uno economico",
        items: [
          {
          ...
          {
            label: 'Design pulito e professionale',
            has: true,
            description: 'Non è un sito fatto da chi non sa fare un sito',
            standardPercent: 3,
            standardLabel: 'Scadente',
          },
          {
          ...
          },
          {
            ...
            standardPercent: 30,
            standardLabel: 'Assente',
          },
          {
            label: 'Reattivo e responsive anche da telefono',
            has: true,
            description:
              'Anche i clienti che ti cercano da telefono possono accedere al tuo sito',
            standardPercent: 6,
            standardLabel: 'Assente',
          },
          {
            label: 'Integrazione con WhatsApp',
            has: true,
            description:
              'Ricevi richieste e contatti dei clienti direttamente su WhatsApp',
            standardPercent: 12,
            standardLabel: 'Assente',
          },
        ],
