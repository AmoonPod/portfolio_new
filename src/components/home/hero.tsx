                    ...
                    <div className="flex flex-col justify-center text-center xl:text-left order-1">
                        <BlurFade delay={0.1}>
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-gray-900 leading-[1.1] mb-6 text-balance">
                                Realizzo <Link href="/siti-web" className="underline decoration-[#FFBC11] decoration-4 underline-offset-4 hover:text-[#FFBC11] hover:no-underline transition-all">siti web</Link> e software per chi vuole <span className="relative whitespace-nowrap text-[#FFBC11] inline-block">
                                    risultati concreti
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center xl:justify-start">
                                ...
                                <WhatsAppButton
                                    size="lg"
                                    className="h-14 md:h-16 px-8 rounded-2xl w-full sm:w-auto shadow-lg transition-all hover:scale-105"
                                    message="Ciao Manuel! Ho visto il tuo portfolio e vorrei parlarti di un progetto."
                                />
                            </div>
