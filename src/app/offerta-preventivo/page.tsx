...
const WHATSAPP_LINK = "https://wa.me/393505764958?text=Ciao%20Manuel!%20Sono%20interessato%20all'offerta%20Landing%20Page%20in%2048%20ore%20a%20347%E2%82%AC.%20Vorrei%20un%20preventivo%20gratuito."
...
export default function OfferLandingPageB() {
    ...
    return (
        <main className="min-h-screen bg-zinc-950 text-white overflow-x-hidden">
                ...
                <div className="bg-[#FFBC11] text-zinc-950 py-2 px-4">
                    <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 text-sm font-medium">
                        ...
                        <Link
                            ...
                            aria-label="Richiedi preventivo gratuito su WhatsApp"
                        >
                            Richiedi Preventivo →
                        </Link>
                    </div>
            ...
            {/* Hero Section - Più compatta per mostrare portfolio subito */}
            <section className="relative min-h-[70vh] flex items-center justify-center px-4 pt-8" aria-labelledby="hero-title">
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <div className="inline-flex items-center gap-2 bg-zinc-900/80 backdrop-blur-sm border border-amber-500/20 rounded-full px-4 py-2 mb-8">
                        <svg className="w-5 h-5 text-[#FFBC11]" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                        <span className="text-sm text-zinc-400">100% trasparenza • Nessun costo nascosto</span>
                    </div>
            ...
            {/* Portfolio Section - SUBITO SOTTO HERO */}
            <section className="py-16 px-4 bg-zinc-900/30" aria-labelledby="portfolio-title">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <span className="text-[#FFBC11] font-medium text-sm uppercase tracking-widest mb-4 block">
                            Guarda prima di decidere
                        </span>
                        <h2 id="portfolio-title" className="text-3xl sm:text-4xl font-bold mb-4">
                            Ecco cosa <span className="text-[#FFBC11]">posso fare per te</span>
                        </h2>
                    </div>
                        ...
                        <div className="relative">
                            ...
                            <article className="relative bg-zinc-900/80 backdrop-blur-sm border border-amber-500/20 rounded-3xl p-8 sm:p-10">
                                ...
                                <div className="text-center mb-8">
                                    <p className="text-zinc-500 text-sm mb-2">Prezzo trasparente</p>
                                    <div className="flex flex-col items-center justify-center gap-1">
                                        <span className="text-5xl sm:text-6xl font-bold text-white" aria-label="Prezzo 347 euro">347€</span>
                                        <span className="text-lg text-zinc-400">invece di <span className="line-through">597€</span></span>
                                    </div>
                                    <p className="text-[#FFBC11] font-medium mt-2">tutto incluso • nessun costo extra</p>
                                </div>

                                {/* Payment Info */}
                                <div className="bg-zinc-800/50 rounded-xl p-4 mb-8">
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-zinc-400">Pagamento sicuro</span>
            ...
            <section className="py-16 px-4 bg-zinc-900/30" aria-labelledby="about-title">
                    ...
                    <div className="relative bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-3xl p-8 sm:p-12 border border-amber-500/20 overflow-hidden">
                        ...
                        <div className="relative text-center">
                            ...
                            <p className="text-zinc-400 text-lg max-w-2xl mx-auto mb-8">
                                Richiedi un <strong>preventivo gratuito senza impegno</strong>. Ti rispondo entro 2 ore con una proposta chiara e trasparente.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                <Link
                                    ...
                                    aria-label="Richiedi subito il tuo preventivo gratuito su WhatsApp"
                                >
